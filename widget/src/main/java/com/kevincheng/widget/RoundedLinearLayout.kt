...
open class RoundedLinearLayout @JvmOverloads constructor(
    ...
    private fun initClipViewStrategy(context: Context, attrs: AttributeSet?) {
        clipViewStrategy = ClipViewStrategy.create(
            ...
            R.styleable.RoundedLinearLayout_rc_radius,
            R.styleable.RoundedLinearLayout_rc_topLeftRadius,
            R.styleable.RoundedLinearLayout_rc_topRightRadius,
            R.styleable.RoundedLinearLayout_rc_bottomLeftRadius,
            R.styleable.RoundedLinearLayout_rc_bottomRightRadius
        )
    }
